  ...
  return (
    <div className='contact-form'>
      <div className="contact-left">
        ...
        <div className="main">
      <div className="up">
        <ButtonSocial className="card1" onClick="/">
          <svg
            className="whatsapp"
        ...
        <ButtonSocial className="card2" onClick="https://www.linkedin.com/in/lo%C3%AFc-rabearivony/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="linkedin"
            height="2.7em"
      ...
      <div className="down">
        <ButtonSocial className="card3" onClick="https://github.com/space9cowboy">
          <svg
            className="github"
            height="50px"
            width="50px"
        ...
        <ButtonSocial className="card4" onClick="/">
          <svg
            className="discord"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 48 48"

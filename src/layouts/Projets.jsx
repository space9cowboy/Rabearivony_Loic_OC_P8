  ...
  return (
    ...
    <div id="projets" className="wrapper">
      ...
      <input type="radio" name="slide" id="c1"  defaultChecked/>
        <CardProject image="/imagebooki.png" htmlForValue="c1" iconModal="1" />

        <input type="radio" name="slide" id="c2" />
        <CardProject image="/imagesophie.png" htmlForValue="c2" iconModal="2"/>

        <input type="radio" name="slide" id="c3" />
        <CardProject image="/imagekasa.png" htmlForValue="c3" iconModal="3"/>

        <input type="radio" name="slide" id="c4" />
        <CardProject image="/imagegrimoire.png" htmlForValue="c4" iconModal="4"/> 
